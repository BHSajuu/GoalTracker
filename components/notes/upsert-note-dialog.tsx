      ...
      {open && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 z-51 pointer-events-none">
            ...
            >
              {/* HEADER */}
              <div className="flex items-center justify-between px-6 py-5 border-b border-white/5 bg-linear-to-b from-white/5 to-transparent">
                    ...
                    <div className="min-h-75">
                      <AnimatePresence mode="wait">
                        ...
                        {activeTab === "link" && (
                          ...
                          >
                               <div className="w-16 h-16 bg-linear-to-br from-primary/20 to-primary/5 rounded-2xl flex items-center justify-center mb-2 border border-primary/10 shadow-lg shadow-primary/5">
