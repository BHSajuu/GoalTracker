...
import { Trash2, Pencil, Terminal, Maximize2, X, Check, Copy } from "lucide-react";
  ...
  return (
    <>
      <Card className="glass md:w-96 group hover:border-primary/30 transition-all mb-4 break-inside-avoid flex flex-col overflow-hidden">
        ...
        <CardContent className="p-0 relative group/code cursor-pointer flex-1 min-h-40" onClick={() => setIsExpanded(true)}>
            <div className="h-48 overflow-hidden relative bg-[#1e1e1e] text-[10px] md:text-xs">
                ...
                <SyntaxHighlighter
                    ...
                    customStyle={{ 
                        ...
                        height: '100%',
                        overflow: 'hidden' // Hide scrollbars in preview
                    }}
                    wrapLines={true}
                >
                    {note.content || ""}
