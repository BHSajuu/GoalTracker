...
export function StatsCards({
  ...
  return (
    ...
    <div className="flex gap-6 overflow-x-auto pb-4 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0 md:grid md:gap-7 md:grid-cols-3 md:overflow-visible snap-x snap-mandatory hide-scrollbar">
      ...
      {/* Card 1 */}
      <Card className="min-w-[75vw] md:min-w-0 snap-center text-center glass border-border/50 hover:shadow-primary/60 transition-all duration-400">
      ...
      {/* Card 2 */}
      <Card className="min-w-[75vw] md:min-w-0 snap-center text-center glass border-border/50 relative overflow-hidden hover:shadow-orange-500/60 transition-all duration-400">
      ...
      {/* Card 3 */}
      <Card className="min-w-[75vw] md:min-w-0 snap-center text-center glass border-border/50 hover:shadow-green-500/60 transition-all duration-400">
        <CardHeader className="flex flex-row items-center justify-center gap-6 md:gap-5 space-y-0">
